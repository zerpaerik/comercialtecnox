			...
			<div class="box-content">
				...
				<form class="form-horizontal" role="form" method="post" action="clientes/create">
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<input type="text" class="form-control" name="apellido" placeholder="Apellido" data-toggle="tooltip" data-placement="bottom" title="Direcciòn">
						</div>
						...
						<div class="col-sm-6">
							<input type="text" class="form-control" name="direccion" placeholder="Direcciòn" data-toggle="tooltip" data-placement="bottom" title="Direcciòn">
						</div>
						...
						<a href="{{route('clientes.index')}}" style="margin-left:15px; margin-top: 20px;" class="col-sm-2 btn btn-danger">Volver</a>
					</div>			
				</form>	
			</div>
		</div>
